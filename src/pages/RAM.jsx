...
export default function RAM() {
  ...
  const handleSave = () => {
    if (!form.brand || !form.serial) {
      alert("Brand and Serial No are required.");
      return;
    }
    if (editId) {
        ...
        <div className="lp-overlay">
          <div className="lp-modal">
            ...
            <div className="lp-modal-footer">
              ...
              <button className="lp-btn-primary" onClick={handleSave}>{editId ? "Update Module" : "Save Module"}</button>
            </div>
          </div>
        </div>
      )}
